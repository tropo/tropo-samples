...
$result = ask( "Hello.  Please enter any single digit", array( "choices" => "[1 DIGIT]" ) );
...
$result = ask( "Hello.  Please enter your 5 digit ZIP code", array( "choices" => "[5 DIGITS]" ) );
...
$result = ask( "Hello.  Please say or enter your 5 digit ZIP code", array( "choices" => "[5 DIGITS]" ) );
...
$result = ask( "Please enter your account ID followed by the pound key.", array( "choices" => "[1-6 DIGITS]" ) );
...
$result = ask( "Please enter your 7 to 10 digit U.S. phone number", array( "choices" => "[7-10 DIGITS]" ) );
